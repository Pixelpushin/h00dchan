...
contract BreedingControllerTest is Test {
    ...
    {
        vm.prank(caller);
        babyId = controller.breed(matronC, matronId, sireC, sireId);
    }
    ...
    function test_Breed_RevertsIfCallerDoesNotOwnOrApproveMatron() public {
        ...
        controller.breed(address(girlfriends), matronId, address(hoodchan), sireId);
    }
    ...
    function test_Breed_SameTokenReverts() public {
        ...
        controller.breed(address(girlfriends), tokenId, address(girlfriends), tokenId);
    }
    ...
    function test_Breed_RevertsIfEitherCollectionNotAllowlisted() public {
        ...
        controller.breed(rogue, matronId, address(girlfriends), sireId);

        vm.prank(matronOwner);
        vm.expectRevert(BreedingController.CollectionNotAllowlisted.selector);
        controller.breed(address(girlfriends), matronId, rogue, sireId);
    }
    ...
    function test_Cooldown_BreedingDuringMatronCooldownReverts() public {
        ...
        controller.breed(address(girlfriends), matronId, address(girlfriends), sireId2);
    }
    ...
    function test_Cooldown_BreedingDuringSireCooldownReverts() public {
        ...
        controller.breed(address(girlfriends), matronId2, address(girlfriends), sireId);
    }
    ...
    function test_Cooldown_KeyedByCollectionAndTokenId_HoodchanAndBabiesDoNotCollide() public {
        ...
        vm.prank(sireOwner);
        vm.expectRevert(BreedingController.MatronOnCooldown.selector);
        controller.breed(address(hoodchan), hcId, address(girlfriends), stillOnCooldownSire);
    ...
    function test_Reentrancy_MaliciousOwnerOfMustFailWholeBreed() public {
        ...
        vm.expectRevert();
        controller.breed(address(evil), 1, address(girlfriends), realSire);
    }
    ...
    function test_Reentrancy_MaliciousGenesOfMustFailWholeBreed() public {
        ...
        vm.prank(matronOwner);
        vm.expectRevert();
        controller.breed(address(girlfriends), realMatron, address(evil), 1);
    }
    ...
    function test_Breed_HoodchanUnsyncedGenesReverts() public {
        ...
        controller.breed(address(hoodchan), hcId, address(girlfriends), sireId);
    }
